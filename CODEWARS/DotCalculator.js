...
// for input. The dots will represent the number in the equation.
...
function dotCalculator (equation) {
    ...
    if (equation.includes("+")) {
        ...
        const arrDots = equation.split(" + ");

        const firstNumber = arrDots[0].length
        const secondNumber = arrDots[1].length
